...
public class StreamExecutionEnvironment {
     ...
     */
    // TODO: 2021/12/13 执行用户指定 entryclass 的 main()
    ...
    public JobExecutionResult execute(String jobName) throws Exception {
         ...
         *   2、每次构造一个 StreamNode 的时候，同时构造一个 StreamEdge
         */
    ...
    public JobClient executeAsync(StreamGraph streamGraph) throws Exception {
        ...
        // TODO: 2021/12/13 根据提交模式选择合适的 executor factory
        ...
        CompletableFuture<JobClient> jobClientFuture =
                // TODO: 2021/12/13 选择合适的 executor
                executorFactory
                        .getExecutor(configuration)
                        // TODO: 2021/12/13 根据已选择的 executor 来执行 StreamGraph
                        /**
                         * TODO: streamGraph 是Pipeline的子类
                         *
                         */
    ...
    @Internal
    /**
     * TODO: 先生成一个StreamGraphGenerator,然后调用generate()方法生成StreamGraph
     *
     */
    ...
    private StreamGraphGenerator getStreamGraphGenerator() {
        ...
        // TODO: 2021/12/13 获取执行模式 Stream & Batch & Automatic
    ...
    public void addOperator(Transformation<?> transformation) {
        ...
        /**
         * TODO: 每个算子的内部实现 ，底层都是构建了一个Transformation加入到Env对象中的List<Transformation> transformations成员变量中
         *
         */
