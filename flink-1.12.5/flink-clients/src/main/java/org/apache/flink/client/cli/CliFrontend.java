...
public class CliFrontend {
    ...
    protected void run(String[] args) throws Exception {
        ...
        // TODO: 获取 run 动作，默认的配置项
        final Options commandOptions = CliFrontendParser.getRunCommandOptions();
        // TODO: 跟进用户指定的配置项，进行解析
        final CommandLine commandLine = getCommandLine(commandOptions, args, true);
        ...
        // TODO: 根据之前添加的顺序，挨个判断是否 active： Generic、Yarn、Default
        final CustomCommandLine activeCommandLine =
                validateAndGetActiveCommandLine(checkNotNull(commandLine));

        final ProgramOptions programOptions = ProgramOptions.create(commandLine);

        // TODO: 获取用户的 jar 包和其他依赖
        final List<URL> jobJars = getJobJarAndDependencies(programOptions);

        // TODO: 获取有效配置： HA 的 id， Target(session/per job)，JoyManager 的内存， TaskManager
        //  的内存，TaskManager的 slot 数
        final Configuration effectiveConfiguration =
    ...
    public static void main(final String[] args) {
        ...
        // TODO: 2021/12/13 从环境变量中获取 conf 目录
        final String configurationDirectory = getConfigurationDirectoryFromEnv();

        // 2. load the global configuration
        // TODO: 2021/12/13 从 conf 目录加载flink-conf.yaml配置文件
        final Configuration configuration =
                GlobalConfiguration.loadConfiguration(configurationDirectory);

        // 3. load the custom command lines
        // TODO: 2021/12/13 解析命令行参数
    ...
    public static List<CustomCommandLine> loadCustomCommandLines(
        ...
        // TODO: 2021/12/13 先解析 GenericCLI
        ...
        try {
            // TODO: 2021/12/13 再解析 YarnSessionCLI
        ...
        // TODO: 2021/12/13 最后解析 DefaultCLI
