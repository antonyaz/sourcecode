...
public class TaskManagerServices {
    ...
    public static TaskManagerServices fromConfiguration(
         ...
         *
         * 当前这个从节点的所有的资源，按照 NumberOfSlot 全部均分
         */
        final TaskSlotTable<Task> taskSlotTable =
                createTaskSlotTable(
                        taskManagerServicesConfiguration.getNumberOfSlots(), // 总slot数量
                        taskManagerServicesConfiguration.getTaskExecutorResourceSpec(), // 从节点的资源配置
