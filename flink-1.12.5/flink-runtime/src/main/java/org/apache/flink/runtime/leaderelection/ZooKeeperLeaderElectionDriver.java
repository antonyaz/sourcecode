...
public class ZooKeeperLeaderElectionDriver
    ...
    public ZooKeeperLeaderElectionDriver(
        ...
        // TODO: 2022/4/30 基于ZooKeeper的Curator框架实现的分布式锁方案的选举组件
        /**
        ...
        // TODO: 2022/4/30 基于ZooKeeper的Curator框架实现的znode节点改变监听
        /**
         * TODO: add by antony at 2022/5/2
         *  监听节点的增删改操作
         *  当监听响应，回调 nodeChanged() 事件
         */
        ...
        /**
         * TODO: 2022/4/30 开启选举
         * 1、如果选举成功，则回调 isLeader()
         * 2、如果选举失败，则回调 notLeader()
         */
