...
public class SessionDispatcherLeaderProcess extends AbstractDispatcherLeaderProcess
    ...
    private Collection<JobGraph> recoverJobsIfRunning() {
        /**
         * TODO: add by antony at 2022/5/2
         * 从 ZK 和 HDFS 中 恢复Job执行 recoverJobs
         * 如果之前的主节点死掉了，那么新的主节点切换过来之后，得接替之前主节点的工作，需要先恢复Job
         */
    ...
    private JobGraph recoverJob(JobID jobId) {
        ...
        try {
            /**
             * TODO: add by antony at 2022/5/2
             * jobGraphStore： JobGraph的存储服务
             * 当一个Job提交到集群中，主节点会把接收到的JobGraph存储在JobGraphStore中
             * 根据JobId从JobGraphStore中来获取JobGraph
             */
