...
public class DefaultScheduler extends SchedulerBase implements SchedulerOperations {
    ...
    public void allocateSlotsAndDeploy(
         ...
         *  2、ExecutuionVertexDeploymentOption 可以给这个ExecutuionVertex 增加一些配置
         *  3、完成 slot 申请之后，就编程了 SlotExecutionVertexAssignment
         *  4、最后被封装为DeploymentHandle ，由这个组件的  deploy() 来完成配置
         *
         *  最终 部署的时候
         *  DeploymentHandle.deploy() =>> ExecutuionVertex.currentExecutuion.deploy()
         */
