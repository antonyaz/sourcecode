...
public class ExecutionVertex
    ...
    public void deploy() throws JobException {
         ...
         *  必要的代码逻辑
         *  1、先获取这个Execution 对应的slot信息
         *  2、根据slot信息，获取得到TaskExecution信息
         *  3、根据TaskExecutor 的注册信息，得到TaskExecutorGateway
         *  4、根据TaskExecutorGateway 发送RPC请求给 TaskExecutor，这个RPC请求就是TaskExecutorGateway.submitTask
         *  5、TaskExecutor 接收到 这个RPC请求，则封装为一个Task对象，通过一个线程来启动这个task
         *
         */
